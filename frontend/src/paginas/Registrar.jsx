    ...
    <>
      ...
      <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
        ...
        >
          ...
          <div className="my-5">
            <label htmlFor="" className=" text-gray-600 block text-xl font-bold">Nombre</label>
            <input
              type="text"
          ...
          <div className="my-5">
            ...
            <label htmlFor="" className=" text-gray-600 block text-xl font-bold">Password</label>
          ...
          <div className="my-5">
            ...
            <label htmlFor="" className=" text-gray-600 block text-xl font-bold">Repetir Password</label>
